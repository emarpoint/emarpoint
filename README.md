...
<p> 
    Последние 2 года работая инженером в строительной сфере понял что данный род деятельности не приносит былого удовольствия, дни стали похожи друг на друга, что могло сказаться на эффективности работы. Нужно было что-то менять. По совету знакомых начал изучать 1С:Предприятие, получил сертификат "1С:Профессионал" но, чувствовал что узко направленные технологии мне не по душе, начал изучать верстку сайтов затем решил пойти дальше и записался на курсы Яндекс.Практикума, курс Python-разработчик. Втянулся в процесс разработки, понравилось написание бэкенд приложения.
Слежу за лекциями Тимофея Хирьянова, решаю задачи на сайте CodeWars.com, читаю техническую литературу:
- Основы программирования на Python (С.А.Чернышев);
- Грокаем алгоритмы (Адитья Бхаргава);
- Django for APIs (Williams S. Vincent).
Занимался мини-футболом, играл в "Корпоративной лиге".
</p>
